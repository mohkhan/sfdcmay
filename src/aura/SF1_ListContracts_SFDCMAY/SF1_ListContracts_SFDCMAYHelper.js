(   
    {   
        ...
        /// order by '+sortField+' '+sortOrder+' LIMIT '+lim +' Offset '+ currentPage;
    // acc, sortField, sortOrder, currentPage
    // getActiveContractsByAccIdPagination(Account acc, Integer lim, Integer currentPage, String sortField, String sortOrder)

    queryRows : function(component, page, sOrder) {
        //getActiveContractsWithProductsAll
        var action = component.get("c.getActiveContractsWithProductsAll");
    ...
    validateState : function(component, results, resultsetsize) {
        
        //console.log('validateState:results:' + results + '; resultsetsize:' + resultsetsize);
        
        if (this.isEmpty(results) || this.isEmpty(resultsetsize) || resultsetsize<1) {
        ...
        //console.log('doneloading=' + component.get("v.doneLoading") + '; noContractsFound=' + component.get("v.noContractsFound"));
    },
        ...
        setCurrencyMisMatch : function (component, event) {
            ...
            //var contractList =  component.get("v.contracts");
            var selectedContractIds = component.get("v.selectedContracts");
            //console.log("conMap="+ JSON.stringify(contractsMap) + '; selectedContracts.length=' + selectedContractIds.length+ '; selectedContracts:' + JSON.stringify(selectedContractIds));
            ...
            if (!this.isEmpty(contractsMap) &&  !this.isEmpty(selectedContractIds)) {
                ...
                for(var i = 0; i < selectedContractIds.length; i++) {
                    ...
                    // alert('selectedContrac Rec:' + JSON.stringify(cont));
        ...
        updateCheckboxhelper: function(component, event, helper) {
            ...
            //console.log('selectedContracts before:' + tmp);
            if (checked) {
            ...
            //tmp.push(contractId);
            //console.log("selectedContracts after:" + tmp);
            ...
            var currencyMisMatch = component.get("v.isContractCurrencyMismatch");
            //console.log("mj" + currencyMisMatch); 
